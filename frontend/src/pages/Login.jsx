          ...
          <div className="mt-6">
            ...
            <div className="mt-4 flex justify-center">
              <button
                ...
                className="flex justify-center items-center gap-2 py-2 px-4 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition duration-200">
